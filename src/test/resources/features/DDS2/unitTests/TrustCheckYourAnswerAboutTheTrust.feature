...
Feature: A trust is able to check their answers for About the Trust section before submitting page
  ...
  Scenario: About the Trust - Change Route validation - With No Change
    ...
    And About The Trust section should have a label "Trust address" at line "2" an answer with "2 Testing Lane,Royal Madeuptown,ZZ9Z 9TT,United Kingdom" and change URL ends with "trust-address/lookup/change"
