...
Feature: A UK tax payer is able to enter the details and continue on What is your telephone number page?
  ...
  Scenario: What is your telephone number? - UI validation
    ...
    And header with text "What is your telephone number?" is displayed
    And body Text "If this is a UK landline or an overseas number, you must include the area or dialing code." is displayed
