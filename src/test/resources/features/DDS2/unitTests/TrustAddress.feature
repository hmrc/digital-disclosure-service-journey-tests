@page
Feature: A UK tax payer is able to enter the details and continue on "What is the country of the trust’s address?"
  
  Scenario: What is the country of the trust’s address? - Select country and navigate to next page
    Given I navigate to "trust-address/lookup" page
  ...
  Scenario: What is the country of the trust’s address? - Select the postcode and property name or number of the trust’s address page
    Given I navigate to "trust-address/lookup" page
    When the page is loaded successfully and verifies the page title is "What is the country of the trust’s address? - Digital Disclosure Service - GOV.UK"
    Then page navigates to "What is the country of the trust’s address?"
    And hint with text "For example, United Kingdom." is displayed
  ...
  Scenario: What is the country of the trust’s address? - International address - navigate to address confirmation page
  Given I navigate to "trust-address/lookup" page
    When page navigates to "What is the country of the trust’s address?"
    When enter country name "Australia",select country "Australia"
    And click on continue button
    Then page navigates to "What is the trust’s address?"
  ...
  Scenario: What is the country of the trust’s address? - Is this the correct address? Navigation
    Given I navigate to "trust-address/lookup" page
    When the page is loaded successfully and verifies the page title is "What is the country of the trust’s address? - Digital Disclosure Service - GOV.UK"
    When enter country name "United Kingdom",select country "United Kingdom"
    And click on continue button
