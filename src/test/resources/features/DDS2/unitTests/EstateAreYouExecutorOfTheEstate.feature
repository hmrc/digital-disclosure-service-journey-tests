@page
  ...
  Scenario: Are you executor of the estate that the disclosure will be about? - Navigation with first radio button
    Given I navigate to "are-you-the-executor" page
  ...
  Scenario: Are you executor of the estate that the disclosure will be about? - No, Navigation with second radio button
    Given I navigate to "are-you-the-executor" page
  ...
  Scenario: Are you executor of the estate that the disclosure will be about? - No selection error message & summary Validation
    Given I navigate to "are-you-the-executor" page
    And click on Save and Continue button
