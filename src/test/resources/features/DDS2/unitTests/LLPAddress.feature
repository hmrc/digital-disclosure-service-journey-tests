Feature: A UK tax payer is able to enter the details and continue on "What is the country of the limited liability partnership’s address?"
  ...
  Scenario: What is the country of the limited liability partnership’s address? - International address - navigate to address confirmation page
  Given I navigate to "llp-address/lookup" page
    When page navigates to "What is the country of the limited liability partnership’s address?"
    When enter country name "Australia",select country "Australia"
    And click on continue button
    Then page navigates to "What is the limited liability partnership’s address?"
