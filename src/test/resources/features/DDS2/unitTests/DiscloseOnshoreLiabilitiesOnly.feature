...
Feature: UI Validation and Navigation  for Screen "The disclosure is only about onshore liabilities"
  ...
  Scenario: Disclose onshore liabilities Only - UI Validation
    ...
    And body Text "As you have no offshore liabilities to disclose, the disclosure can only be about onshore liabilities. You have onshore liabilities if you are classed as a resident (opens in a new tab) in the UK and:" is displayed
