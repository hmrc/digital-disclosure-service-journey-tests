...
Feature: An individual UK tax payer is able to check their answers for background section before submitting page
  ...
  Scenario: On behalf of Individual - Change Route validation -  From Yes to No on behalf of the individual - Are you the individual this disclosure relates to?
    ...
    And About The Individual section should have a label "Individual’s main occupation" at line "3" an answer with "1 January 1980" and change URL ends with "individual-main-occupation/change"
    And About The Individual section should have a label "Does the individual have a National Insurance number, as far as you’re aware?" at line "4" an answer with "Yes, and I know my National Insurance number" and change URL ends with "individual-have-national-insurance-number/change"
    ...
    And About The Individual section should have a label "Is the individual registered for VAT, as far you’re aware?" at line "6" an answer with "Yes, and I know my VAT registration number" and change URL ends with "individual-registered-for-vat/change"
    ...
    And About The Individual section should have a label "Is the individual registered for Self Assessment, as far as you’re aware?" at line "8" an answer with "Yes, and I know my Unique Taxpayer Reference (UTR)" and change URL ends with "individual-registered-for-self-assessment/change"
    And About The Individual section should have a label "Individual’s Unique Taxpayer Reference" at line "9" an answer with "1234567890" and change URL ends with "your-utr/change"
