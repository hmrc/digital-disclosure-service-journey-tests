...
Feature: A UK tax payer is able to enter the details and continue on "What is the individual’s Unique Tax Reference?"
  ...
  @id002
  Scenario: What is the individual’s Unique Tax Reference?  - Enter valid UTR
    Given I am on What is the individual Unique Tax Reference Page
  ...
  @id003
  Scenario: What is the individual’s Unique Tax Reference?  - Leave blank input field
    Given I am on What is the individual Unique Tax Reference Page
    When I enter "" in the TextBox field
    And click on Save and Continue button
    Then error summary popup should be displayed with text "There is a problem"
    And error message should be displayed with text "Enter the individual’s Unique Tax Reference"

  @id_004
  Scenario: What is the individual’s Unique Tax Reference?  - Navigation of on Error message on top popup
    Given I am on What is the individual Unique Tax Reference Page
    When I enter "" in the TextBox field
    And click on Save and Continue button
    And I click on problem message "Enter the individual’s Unique Tax Reference"
    Then I should navigate to UTR number TextBox field

  @id_005
  Scenario: What is the individual’s Unique Tax Reference?  - Navigation with Back button
  ...
  @id006
  Scenario: What is the individual’s Unique Tax Reference?  - Enter valid UTR-with 10 digit and spaces
    Given I am on What is the individual Unique Tax Reference Page
  ...
  @id007
  Scenario: What is the individual’s Unique Tax Reference?  - Enter invalid UTR- less than 10 digit
    Given I am on What is the individual Unique Tax Reference Page
  ...
  @id008
  Scenario: What is the individual’s Unique Tax Reference?  - Enter invalid UTR- greater than 10 digit
    Given I am on What is the individual Unique Tax Reference Page
  ...
  @id009
  Scenario: What is the individual’s Unique Tax Reference?  - Enter invalid UTR- non numeric character
    Given I am on What is the individual Unique Tax Reference Page
