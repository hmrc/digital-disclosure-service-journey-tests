...
Feature: A UK tax payer is able to enter the details and continue on What is the individual's VAT registration number page?
  ...
  Scenario: What is the individual's VAT registration number? - Leave blank input field
    Given I am on What is the individual's VAT registration number page
    When I enter "" in the TextBox field
    And click on Save and Continue button
    Then error summary popup should be displayed with text "There is a problem"
    And error message should be displayed with text "Enter the individual's VAT registration number"

  Scenario: What is the individual's VAT registration number?  - Enter VAT number, continue to the next page and navigate back
    Given I am on What is the individual's VAT registration number page
    When I enter "123569878" in the TextBox field
    And click on Save and Continue button
    Then I am navigated to the next page with title "Is the individual registered for Self Assessment, as far as you’re aware? - Digital Disclosure Service - GOV.UK"
    When I click on Back button
    Then I am navigated back to the page with title "What is the individual's VAT registration number? - Digital Disclosure Service - GOV.UK"

  Scenario: What is the individual's VAT registration number?  - Enter Valid VAT number with spaces
    Given I am on What is the individual's VAT registration number page
    When I enter "123 569 878" in the TextBox field
    And click on Save and Continue button
    Then I am navigated to the next page with title "Is the individual registered for Self Assessment, as far as you’re aware? - Digital Disclosure Service - GOV.UK"

  Scenario: What is the individual's VAT registration number?  - Enter Valid VAT number with GB
    Given I am on What is the individual's VAT registration number page
    When I enter "GB123569878" in the TextBox field
    And click on Save and Continue button
    Then I am navigated to the next page with title "Is the individual registered for Self Assessment, as far as you’re aware? - Digital Disclosure Service - GOV.UK"

  Scenario: What is the individual's VAT registration number?  - Enter Valid VAT number with GB and spaces
    Given I am on What is the individual's VAT registration number page
    When I enter "GB 123 569 878" in the TextBox field
    And click on Save and Continue button
    Then I am navigated to the next page with title "Is the individual registered for Self Assessment, as far as you’re aware? - Digital Disclosure Service - GOV.UK"

  Scenario Outline: What is the individual's VAT registration number? - Validate error messages on VAT page
    Given I am on What is the individual's VAT registration number page
