Feature: A UK tax payer residing abroad is able to enter the details and continue on "What is the country of your address?"
  ...
  Scenario: What is your address? - International page - Enter valid data in all fields, verify on the confirm page and edit the address
    Given I am on What is the country of your address Page
    When enter country name "Australia",select country "Australia"
    And click on continue button
    Then page navigates to "What is your address?"
  ...
  Scenario: What is your address? - International page - Enter valid data in minimum fields, verify on the confirm page and edit the address
    Given I am on What is the country of your address Page
    When enter country name "Australia",select country "Australia"
    And click on continue button
    Then page navigates to "What is your address?"
