...
Feature: An individual is able to check their answers for About the Company section before submitting page
  ...
  Scenario: On behalf of the LLP - About the LLP - Change Route LLP address
    ...
    And About The LLP section should have a label "Limited liability partnership’s address" at line "2" an answer with "2 Testing Lane,Royal Madeuptown,ZZ9Z 9TT,United Kingdom" and change URL ends with "llp-address/lookup/change"
