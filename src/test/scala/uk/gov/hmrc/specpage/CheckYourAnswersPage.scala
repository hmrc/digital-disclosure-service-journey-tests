...
trait CheckYourAnswersPage extends BasePage {
  ...
  def verifyAboutYouAnswers(lineNo: String, expectedLabel: String, expectedAnswer: String, expectedChangeURL: String): Unit = {
    val actualLabel = Driver.instance.findElement(By.xpath("//dl[@id='about-you-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dt[@class='govuk-summary-list__key']")).getText.trim
    ...
    val actualAnswer = Driver.instance.findElement(By.xpath("//dl[@id='about-you-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__value']")).getText.trim
    if (expectedLabel != "Your contact preference") {
    ...
    val getChangeURL = Driver.instance.findElement(By.xpath("//dl[@id='about-you-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__actions']/a[@class='govuk-link']")).getAttribute("href")
  ...
  def verifyAboutTheIndividualAnswers(expectedLabel: String,lineNo: String, expectedAnswer: String, expectedChangeURL: String): Unit = {
    val actualLabel = Driver.instance.findElement(By.xpath("//dl[@id='about-the-individual-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dt[@class='govuk-summary-list__key']")).getText.trim
    ...
    val actualAnswer = Driver.instance.findElement(By.xpath("//dl[@id='about-the-individual-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__value']")).getText.trim
    ...
    val getChangeURL = Driver.instance.findElement(By.xpath("//dl[@id='about-the-individual-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__actions']/a[@class='govuk-link']")).getAttribute("href")
  ...
  def verifyAboutTheCompanyAnswers(expectedLabel: String, lineNo: String, expectedAnswer: String, expectedChangeURL: String): Unit = {
    val actualLabel = Driver.instance.findElement(By.xpath("//dl[@id='about-the-company-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dt[@class='govuk-summary-list__key']")).getText.trim
    ...
    val actualAnswer = Driver.instance.findElement(By.xpath("//dl[@id='about-the-company-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__value']")).getText.trim
    ...
    val getChangeURL = Driver.instance.findElement(By.xpath("//dl[@id='about-the-company-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__actions']/a[@class='govuk-link']")).getAttribute("href")
  ...
  def verifyAboutTheTrustAnswers(expectedLabel: String, lineNo: String, expectedAnswer: String, expectedChangeURL: String): Unit = {
    val actualLabel = Driver.instance.findElement(By.xpath("//dl[@id='about-the-trust-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dt[@class='govuk-summary-list__key']")).getText.trim
    ...
    val actualAnswer = Driver.instance.findElement(By.xpath("//dl[@id='about-the-trust-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__value']")).getText.trim
    ...
    val getChangeURL = Driver.instance.findElement(By.xpath("//dl[@id='about-the-trust-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__actions']/a[@class='govuk-link']")).getAttribute("href")
  ...
  def verifyAboutTheLLPAnswers(expectedLabel: String, lineNo: String, expectedAnswer: String, expectedChangeURL: String): Unit = {
    val actualLabel = Driver.instance.findElement(By.xpath("//dl[@id='about-the-llp-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dt[@class='govuk-summary-list__key']")).getText.trim
    ...
    val actualAnswer = Driver.instance.findElement(By.xpath("//dl[@id='about-the-llp-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__value']")).getText.trim
    ...
    val getChangeURL = Driver.instance.findElement(By.xpath("//dl[@id='about-the-llp-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__actions']/a[@class='govuk-link']")).getAttribute("href")
  ...
  def verifyAboutThePersonDiedAnswers(expectedLabel: String, lineNo: String, expectedAnswer: String, expectedChangeURL: String): Unit = {
    val actualLabel = Driver.instance.findElement(By.xpath("//dl[@id='about-the-person-who-died-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dt[@class='govuk-summary-list__key']")).getText.trim
    ...
    val actualAnswer = Driver.instance.findElement(By.xpath("//dl[@id='about-the-person-who-died-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__value']")).getText.trim
    ...
    val getChangeURL = Driver.instance.findElement(By.xpath("//dl[@id='about-the-person-who-died-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__actions']/a[@class='govuk-link']")).getAttribute("href")
  ...
  def verifyBackgroundAnswers(dataTable: DataTable): Unit = {
    ...
    dataTable.asScalaMaps[String, String] // Seq[Map[String, Option[String]]]
      .map { row =>
        ...
        val actualLabel = Driver.instance.findElement(By.xpath("//dl[@id='background-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dt[@class='govuk-summary-list__key']")).getText
        Assert.assertTrue("Check your answers - Background - Label not verified. Expected: " + label+ "--- Actual: " + actualLabel, label == actualLabel)

        val actualAnswer = Driver.instance.findElement(By.xpath("//dl[@id='background-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__value']")).getText
        ...
        val getChangeURL = Driver.instance.findElement(By.xpath("//dl[@id='background-list']/div[@class='govuk-summary-list__row'][" + lineNo + "]/dd[@class='govuk-summary-list__actions']/a[@class='govuk-link']")).getAttribute("href")
    ...
    outloop.breakable{
      elementLabel.forEach(e =>
        if (e.getText.trim == expectedText.trim) {
          Driver.instance.findElement(By.xpath("(//div[@class='govuk-summary-list__row']//a[@class='govuk-link'])["+line+"]")).click()
          outloop.break()
        }
        else {
          line=line+1
  ...
  def verifyDropdownTextBoxIsEmpty(): Unit = {
    val element = Driver.instance.findElement(By.xpath("//input[@id='countryCode']"))
