...
object ContactByEmailStepDefSteps extends BasePage with ContactByEmailPage {
  ...
  // I am on Do you have an email address that you are happy to be contacted on by HMRC Page
  def givenIAmOnDoYouHaveAnEmailAddressThatYouAreHappyToBeContactedOnByHMRCPage(): Unit = {
