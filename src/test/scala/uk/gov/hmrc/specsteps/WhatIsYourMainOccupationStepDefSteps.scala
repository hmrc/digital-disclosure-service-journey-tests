...
object WhatIsYourMainOccupationStepDefSteps extends BasePage  with WhatIsYourMainOccupationPage {
  ...
  // I am on What is your main occupation page
  def givenIAmOnWhatIsYourMainOccupationPage(): Unit = {
    navigateToSpecificPage("notification/your-main-occupation")
  }

  // I enter {string} in the TextBox field
  def thenIEnterStringInTheTextBoxField(string: String): Unit = {
    enterInputInTextBox(string)
  }

  // I should navigate to TextBox field
  def thenIShouldNavigateToTextBoxField(): Unit = {
