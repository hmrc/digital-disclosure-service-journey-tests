...
object WhatIsYourTelephoneNumberStepDefSteps extends BasePage with WhatIsYourTelephoneNumberPage {
  ...
  // I am on What is your telephone number page
  def givenIAmOnWhatIsYourTelephoneNumberPage(): Unit = {
    navigateToSpecificPage("notification/your-telephone-number")
  }

  // body text should be {string}
  def thenBodyTextShouldBeString(string: String): Unit = {
