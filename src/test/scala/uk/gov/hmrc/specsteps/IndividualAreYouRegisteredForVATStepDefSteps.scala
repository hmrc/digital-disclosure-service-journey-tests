...
object IndividualAreYouRegisteredForVATStepDefSteps extends BasePage with WhatIsYourDOBPage {
  ...
  // I am on Is the individual registered for VAT, as far you’re aware page as {string} tax payer
  def givenIAmOnIsTheIndividualRegisteredForVATAsFarYouReAwarePageAsStringTaxPayer(string: String): Unit = {
