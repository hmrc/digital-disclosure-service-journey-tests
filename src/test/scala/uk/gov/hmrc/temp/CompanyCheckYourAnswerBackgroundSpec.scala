...
import uk.gov.hmrc.specsteps.AreYouRepresentingOrganisationStepDefSteps
import uk.gov.hmrc.specsteps.CheckYourAnswersStepDefSteps
import uk.gov.hmrc.specsteps.NotificationSubmittedStepDefSteps
import uk.gov.hmrc.specsteps.OffshoreDisclosureStepDefSteps
import uk.gov.hmrc.specsteps.ReceivedALetterStepDefSteps
...
class CompanyCheckYourAnswerBackgroundSpec extends BaseSpec {
  ...
  Feature("An Company tax payer is able to check their answers for background section before submitting page") {
    ...
    Scenario("Company - Background - Change route to - Are you an officer of the company? from No to Yes") {
      ...
      CheckYourAnswersStepDefSteps.givenIAmOnStringPage("")
      ...
      OffshoreDisclosureStepDefSteps.whenIClickOnMakeADisclosureButton()
        // --- Other possible matches ---
      ...
      And("I select Radio Button I am an accountant or tax agent at Position 2")
        // Possible match (best=0.56)
      ReceivedALetterStepDefSteps.whenISelectYesRadioButton()
        // --- Other possible matches ---
      ...
      ReceivedALetterStepDefSteps.whenClickOnSaveAndContinueButton()
        // --- Other possible matches ---
      ...
      Then("page navigates to Check Your Answers")
        // Possible match (best=0.56)
      AreYouRepresentingOrganisationStepDefSteps.givenINavigateToStringPage("")
        // --- Other possible matches ---
      ...
      And("Background section has following")
        // Possible match (best=1.00)
      CheckYourAnswersStepDefSteps.thenBackgroundSectionHasFollowing(null)

      And("answers page should have h2 header About you")
        // Possible match (best=0.60)
      CheckYourAnswersStepDefSteps.thenAnswersPageShouldHaveH2HeaderString("")
        // --- Other possible matches ---
      ...
      CheckYourAnswersStepDefSteps.thenLineStringShouldHaveALabelStringAnAnswerWithStringAndChangeURLEndsWithString("", "", "", "")
      ...
      CheckYourAnswersStepDefSteps.thenAboutTheCompanySectionShouldHaveALabelStringAtLineStringAnAnswerWithStringAndChangeURLEndsWithString("", "", "", "")
        // --- Other possible matches ---
      ...
      When("I click on send notification button")
        // Possible match (best=1.00)
      NotificationSubmittedStepDefSteps.whenIClickOnSendNotificationButton()
        // --- Other possible matches ---
        // whenIClickOnContinueButton() [0.56] (HomePageStepDefSteps.scala) pattern: I click on continue button
        // whenClickOnIConfirmButton() [0.56] (DiscloseOffshoreLiabilitiesStepDefSteps.scala) pattern: click on I confirm button
        // whenIClickOnBackButton() [0.56] (ReceivedALetterStepDefSteps.scala) pattern: I click on Back button
      ...
      NotificationSubmittedStepDefSteps.thenTheCaseReferenceShouldBeString("")
