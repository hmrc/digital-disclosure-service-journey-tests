...
import uk.gov.hmrc.specsteps.OffshoreDisclosureStepDefSteps.{thenStatusIsMarkedAsStringForFieldString, whenIClickOnMakeADisclosureButton, whenINavigateToStringSpecificPage, whenPageShouldDisplayCheckboxesForTheStringTaxYearsBeforeTheCurrentTaxYear}
import uk.gov.hmrc.specsteps.OnshoreDisclosureStepDefSteps.{checkTaskStatus, enterTextInDescription, enterValueInStopDay, enterValueInStopMonth, enterValueInStopYear, enterValueInwhatHasHappenedToPropertyTextArea, whenIEnterStringInLandloardAssociationTextBoxField, whenIEnterStringInPercentageTextBoxField, whenIEnterStringInPropertyCountTextBoxField, whenIEnterStringInStopDayTextBoxField, whenIEnterStringInStopMonthTextBoxField, whenIEnterStringInStopYearTextBoxField, whenIEnterStringInTaxOwedReasonTextBoxField, whenIEnterStringInTypeOfMortageTextBoxField, whenIEnterStringInWhatHasHappenedToPropertyTextBoxField, whenIEnterStringInYearNotSelectedTextBoxField}
...
import uk.gov.hmrc.specsteps.WhatIsTheCountryOfYourAddressStepDefSteps.{whenClickOnConfirmButton, whenClickOnContinueButton}
