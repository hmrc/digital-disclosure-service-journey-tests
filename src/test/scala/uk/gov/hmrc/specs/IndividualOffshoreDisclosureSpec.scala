...
import uk.gov.hmrc.specsteps.HomePageStepDefSteps.{enterInputInTextBox, saveAndContinue, _}
import uk.gov.hmrc.specsteps.InternationalAddressStepDefSteps.{enterInputInManualAddressPage, selectfromDropdown}
import uk.gov.hmrc.specsteps.OffshoreDisclosureStepDefSteps.{whenIClickOnMakeADisclosureButton, whenIEnterCountryOrTerritoryStringAndSelectString}
...
import uk.gov.hmrc.specsteps.ReceivedALetterStepDefSteps.{givenIAmNavigatedToReceivedALetterPage, thenISelectNoRadioButton, whenClickOnSaveAndContinueButton}
...
class IndividualOffshoreDisclosureSpec extends BaseSpec {
  ...
  Feature("An Individual is able to notify and submit offshore disclosure") {
    Scenario("Individual - Complete offshore disclosure with reasonable excuse journey") {
      ...
      When("I am on You have sent your notification page")
       verifyPageHeading("You have sent your notification page")
      ...
      Then("page navigates to Why you submitted an inaccurate return")
       verifyPageHeading("Why you submitted an inaccurate return")

      And("I select Checkbox I took reasonable care but made a mistake at Position 2")
       clickOnCheckBox("I took reasonable care but made a mistake", "2")

      And("click on Save and Continue button")
       saveAndContinue()

      Then("page navigates to Your reasonable excuse for not notifying HMRC about a tax liability")
       verifyPageHeading("Your reasonable excuse for not notifying HMRC about a tax liability")
      ...
      Then("page navigates to Your reasonable excuse for not filing a return")
       verifyPageHeading("Your reasonable excuse for not filing a return")
      ...
      Then("page navigates to What reasonable care did you take when submitting the inaccurate return?")
       verifyPageHeading("What reasonable care did you take when submitting the inaccurate return?")
      ...
      And("I select Radio Button No at Position 1")
       clickOnRadioButton("Yes","1")
    ...
    Scenario("Individual - Complete offshore disclosure with no reasonable excuse journey") {
      ...
      And("I select Checkbox This was not deliberate, but I do not have a reasonable excuse at Position 1")
       clickOnCheckBox("This was not deliberate, but I do not have a reasonable excuse", "1")
      ...
      And("I select Checkbox I did not file a return but I did not withhold any information on purpose at Position 1")
       clickOnCheckBox("I did not file a return but I did not withhold any information on purpose", "1")
      ...
      And("I select Checkbox I did not take reasonable care at Position 1")
       clickOnCheckBox("I did not take reasonable care", "1")
      ...
      And("I select Checkbox 6 April 2021 to 5 April 2022 at Position 4")
       clickOnCheckBox("6 April 2021 to 5 April 2022", "4")
    ...
    Scenario("Individual - Complete offshore disclosure journey - Nil disclosure") {
      ...
      And("I select Checkbox I deliberately submitted an inaccurate return at Position 3")
       clickOnCheckBox("I deliberately submitted an inaccurate return", "3")
      ...
      When("I select Checkbox Any tax year before 6 April 2006 at Position 20")
       clickOnCheckBox("Any tax year before 6 April 2006", "20")

      And("click on Save and Continue button")
       saveAndContinue()

      Then("page navigates to Can you tell us more about any tax owed before 6 April 2006?")
       verifyPageHeading("Can you tell us more about any tax owed before 6 April 2006?")
    ...
    Scenario("Individual - Complete offshore disclosure with reasonable excuse journey - Complete flow for Nil disclosure") {
      ...
      Then("page navigates to Why you are making this disclosure")
       clickOnHyperlinkText("Why you are making this disclosure")
      ...
      When("I select Checkbox Any tax year before 6 April 2015 at Position 11")
      ...
      Then("page navigates to Did you receive tax credits for any of the years covered by your disclosure?")
       verifyPageHeading("Did you receive tax credits for any of the years covered by your disclosure?")
      ...
      Then("page navigates to Did someone give you advice that led you to not declare these tax issues previously?")
       verifyPageHeading("Did someone give you advice that led you to not declare these tax issues previously?")
      ...
      Then("page navigates to You have sent a nil disclosure")
       verifyPageHeading("You have sent a nil disclosure")
    ...
    Scenario("Individual - Complete offshore disclosure with no reasonable excuse journey - Complete flow") {
      ...
      And("I select Checkbox I deliberately failed to notify HMRC of a tax liability at Position 3")
       clickOnCheckBox("I deliberately failed to notify HMRC of a tax liability", "3")
      ...
      And("I select Checkbox I deliberately withheld information by failing to submit a return at Position 3")
       clickOnCheckBox("I deliberately withheld information by failing to submit a return", "3")
      ...
      When("I select Radio Button A different email address at Position 2")
       clickOnRadioButton("A different email address","2")

      And("click on Save and Continue button")
       saveAndContinue()

      Then("page navigates to What email address can we contact you with?")
       verifyPageHeading("What email address can we contact you with?")

      When("I enter xyz@xyz.com in the TextBox field")
       enterInputInTextBox("xyz@xyz.com")
