...
import uk.gov.hmrc.specsteps.CheckYourAnswersStepDefSteps.{clickOnChangeButton, thenBackgroundSectionHasFollowing, verifyAboutTheTrustAnswers, verifyAboutYouAnswers}
